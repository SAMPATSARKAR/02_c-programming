...
int main(){
    ...
    //strnset(string1, 'x',1); // sets first n characters of a string to agiven character
    //strrev(string1); // reverse a string

    //int result = strlen(string1); // returns string length as int
    //int result = strcmp(string1, string2); // string compare all characters and return zero if same
    
    //int result = strcmp(string1, string2,1); // string compare n characters
